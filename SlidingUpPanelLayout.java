...
/**
 * Created by liudunjian on 2018/7/2.
 */
...
public class SlidingUpPanelLayout extends ViewGroup {
     ...
     */
    private static final int DEFAULT_PANEL_HEIGHT = 80;
    ...
    /**
     * another view that forbid the interceptor event
     */
    private View mExtralScrollableView;
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            if (ta != null) {
                mPanelHeight = AutoLayoutConifg.getInstance().getPercentSize(ta.getDimensionPixelSize(R.styleable.SlidingUpPanelLayout_umanoPanelHeight, DEFAULT_PANEL_HEIGHT));
                mShadowHeight = AutoLayoutConifg.getInstance().getPercentSize(ta.getDimensionPixelSize(R.styleable.SlidingUpPanelLayout_umanoShadowHeight, DEFAULT_SHADOW_HEIGHT));
                mParallaxOffset = AutoLayoutConifg.getInstance().getPercentSize(ta.getDimensionPixelSize(R.styleable.SlidingUpPanelLayout_umanoParallaxOffset, DEFAULT_PARALLAX_OFFSET));
...
//        }
    ...
    /**
     * Set the extra view of the sliding layout. If set, scrolling will be transfered between
     * the panel and the view when necessary
     */
    public void setExtralScrollableView(View View) {
        mExtralScrollableView = View;
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            if (!isViewUnder(mScrollableView, (int) mInitialMotionX, (int) mInitialMotionY) && !isViewUnder(mExtralScrollableView, (int) mInitialMotionX, (int) mInitialMotionY)) {
                return super.dispatchTouchEvent(ev);
            }
            ...
            if (dy * (mIsSlidingUp ? 1 : -1) > 0) { // Collapsing
                ...
                if (mScrollableViewHelper.getScrollViewScrollPosition(mExtralScrollableView, mIsSlidingUp) > 0 && isViewUnder(mExtralScrollableView, (int) mInitialMotionX, (int) mInitialMotionY)) {

                    mIsScrollableViewHandlingTouch = true;
                    return super.dispatchTouchEvent(ev);
                }

                if (mScrollableViewHelper.getScrollViewScrollPosition(mScrollableView, mIsSlidingUp) > 0 && isViewUnder(mScrollableView, (int) mInitialMotionX, (int) mInitialMotionY)) {
